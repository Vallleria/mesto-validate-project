const CardsModule = (function(){
    ...
    function getCard(link, name) {
        ...
        cardImage.addEventListener('click', function () {
            ...
            ModalModule.showImagePopupImg.src = link;
            ModalModule.showImagePopupImg.alt = name;
    
            ModalModule.showImagePopup.querySelector('.show-image-popup__title').textContent = name;
            // показать show-image-popup
            ModalModule.togglePopup(ModalModule.showImagePopup);
        })
        return card;
    }
